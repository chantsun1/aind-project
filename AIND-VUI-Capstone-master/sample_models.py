...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(1,recur_layers+1):
        if i == 1:
            ...
            rnn = GRU(units, activation='relu',
                return_sequences=True, implementation=2, name='rnn' + str(i))(rnn)
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    conv_1d = Conv1D(filters, kernel_size, 
                     ...
                     activation='relu',
                     name='conv1d')(input_data)
    #conv_1d_maxpool = MaxPooling1D()(conv_1d)
    # Add batch normalization
    bn_cnn = BatchNormalization(name='bn_conv_1d')(conv_1d)
    # Add recurrent layer
    for i in range(1,recur_layers+1):
        if i == 1:
            rnn = Bidirectional(GRU(units, activation='relu',
                return_sequences=True, implementation=2, dropout=0.25, recurrent_dropout=0.25, name='rnn' + str(i)), 
